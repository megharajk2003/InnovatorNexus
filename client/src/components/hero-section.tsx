...
export default function HeroSection() {
  const { isVisible: heroVisible, elementRef: heroRef } = useScrollAnimation({ threshold: 0.2 });
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center min-h-screen">
          <div 
            ...
            className="space-y-8"
          >
            <h1 className={`text-5xl lg:text-6xl font-bold font-poppins leading-tight transition-all duration-1000 ${
              heroVisible 
            ...
            <p className={`text-xl text-gray-600 leading-relaxed transition-all duration-1000 delay-300 ${
              heroVisible 
                ? 'opacity-100 translate-y-0' 
                : 'opacity-0 translate-y-8'
            }`}>
          ...
          <div className={`relative transition-all duration-1000 delay-700 ${
            ...
            />
            <div className={`absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg transition-all duration-1000 delay-1000 ${
              heroVisible 
                ? 'opacity-100 translate-y-0' 
                : 'opacity-0 translate-y-8'
            }`}>
