...
export default function Articles() {
  ...
  const categories = ["All", "Social Media", "Content Marketing", "Business Strategy", "Design", "Web Development"];

  const articles = [
    {
      id: 1,
      title: "10 Social Media Trends That Will Dominate 2025",
      excerpt: "Discover the latest social media trends and how to leverage them for maximum engagement and business growth.",
    ...
    },
    {
      ...
      excerpt: "Learn how to measure and improve your content marketing return on investment with proven strategies and tools.",
    ...
    },
    {
      ...
      excerpt: "Essential steps to create a memorable brand identity that resonates with your target audience across all digital platforms.",
      category: "Design",
    ...
    },
    {
      ...
      excerpt: "Practical SEO strategies that small businesses can implement to improve their search engine rankings and visibility.",
      category: "Web Development",
      readTime: "15 min read",
      publishDate: "2025-01-08",
      image: "https://images.unsplash.com/photo-1432888622747-4eb9a8efeb07?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=250",
      author: "David Kim",
      featured: false
    },
    {
      ...
      excerpt: "Understand your customers better and optimize their experience with comprehensive journey mapping techniques.",
    ...
    },
    {
      ...
      excerpt: "Latest video marketing statistics and insights to help you create more effective video content strategies.",
      category: "Content Marketing",
      readTime: "6 min read",
    ...
    <div className="min-h-screen bg-white">
      ...
      {featuredArticles.length > 0 && (
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-3xl font-bold font-poppins mb-12 text-center">Featured Articles</h2>
      ...
      {/* Regular Articles */}
      <section ref={articlesRef} className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {featuredArticles.length > 0 && (
            <h2 className="text-3xl font-bold font-poppins mb-12 text-center">Latest Articles</h2>
          )}
              ...
              {regularArticles.map((article, index) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-gray-600 mb-4 leading-relaxed text-sm line-clamp-3">{article.excerpt}</p>
                    <div className="flex items-center justify-between">
                      <div className="flex flex-col space-y-1">
                        <Badge variant="secondary" className="text-xs w-fit">{article.category}</Badge>
