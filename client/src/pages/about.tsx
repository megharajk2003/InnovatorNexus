...
export default function About() {
  ...
  const values = [
    ...
    },
    {
      icon: Heart,
      title: "Passion",
      description: "Our team is driven by genuine passion for helping businesses succeed in the digital landscape."
    },
    {
      icon: Users,
      title: "Collaboration",
      description: "We believe in working closely with our clients as true partners in their growth journey."
    },
    {
      icon: Award,
      title: "Excellence",
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      description: "Regular, detailed reports that show exactly how we're driving your success"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We are a forward-thinking digital services company dedicated to transforming businesses 
              through innovative social media strategies, compelling content creation, and strategic business consulting.
            </p>
          </div>
        </div>
      </section>
          ...
          >
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6 leading-relaxed">
                At Innovator Nexus, we believe every business has the potential to create meaningful 
                connections with their audience. Our mission is to bridge the gap between brands and 
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-lg font-semibold">Strategic Planning</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Users className="w-6 h-6 text-primary" />
                  <span className="text-lg font-semibold">Community Building</span>
                </div>
                <div className="flex items-center space-x-3">
                  <Award className="w-6 h-6 text-primary" />
                  <span className="text-lg font-semibold">Results-Driven Solutions</span>
                </div>
              </div>
            </div>
            <div>
            ...
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-xl font-bold font-poppins mb-4 text-center">{value.title}</h3>
            ...
            {whyChooseUs.map((item, index) => (
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold font-poppins mb-2">{item.title}</h3>
