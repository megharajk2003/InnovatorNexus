...
export default function Services() {
  ...
  const { isVisible: newsletterVisible, elementRef: newsletterRef } = useScrollAnimation();

  const services = [
    {
      icon: MessageCircle,
      title: "Social Media Management",
      description: "Comprehensive social media strategy, content planning, community management, and performance analytics across all major platforms.",
    ...
    },
    {
      ...
      description: "Engaging, high-quality content including blog posts, video content, infographics, and multimedia assets that resonate with your audience.",
      features: ["Blog Writing", "Video Production", "Infographic Design", "Copywriting"],
      color: "secondary"
    },
    {
      icon: BarChart3,
      title: "Business Strategy",
      description: "Data-driven strategic planning, market analysis, competitive research, and growth optimization frameworks for sustainable success.",
    ...
    },
    {
      ...
      description: "Professional brand identity design, marketing materials, digital assets, and visual communications that make lasting impressions.",
    ...
    },
    {
      ...
      description: "Professional photography and videography services for marketing campaigns, product showcases, and brand storytelling.",
      features: ["Product Photography", "Brand Videos", "Marketing Content", "Event Coverage"],
      color: "accent"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              ...
              and drive meaningful business results across all channels.
            </p>
          </div>
        </div>
      </section>
                  ...
                  <div className="space-y-3 mb-6">
                    {service.features.map((feature, featureIndex) => (
                      <div key={featureIndex} className="flex items-center space-x-3">
                        <CheckCircle className={`w-5 h-5 ${colorClasses.text}`} />
                        <span className="text-gray-700">{feature}</span>
                      </div>
                    ))}
                  </div>
                  
                  <Button className={`w-full ${colorClasses.text} hover:${colorClasses.text}/80`} variant="outline">
                    Learn More
